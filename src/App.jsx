    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Priya</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Priya's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>You mean more to me than words can ever describe! 💗</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Grateful — Batman </h2>
          <p className="final-subtitle">Always cheering for you, no matter what. ✨</p>
        </section>
      </div>
